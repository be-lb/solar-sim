...
var optimizeRoofAreas = function (b, actualPvArea) {
    ...
    var sortRoofProductivities = roofProductivities.sort(function (a, b) { return b - a; });
    var cpt = 0;
...
var optimizeRoofPowers = function (b, potentialPower) {
    var computedPower = potentialPower;
    var roofProductivities = [];
    for (var _i = 0, _a = b.roofs; _i < _a.length; _i++) {
        var r = _a[_i];
        roofProductivities.push(r.productivity);
