...
var thermicSolarSim = function (inputs) {
    ...
    var t = new thermic_1.Thermic(inputs.thermicHouseholdPerson, inputs.thermicLiterByPersonByDay, inputs.thermicHotWaterProducer, inputs.thermicCost, inputs.thermicAnnualMaintenanceCost, inputs.thermicMaintenanceRate, inputs.thermicGrant, inputs.VATrate);
    t.computeCost();
    t.computeAnnualMaintenanceCost();
    t.building = b;
    t.computeSolarProduction();
    t.computePumpConsumption();
    var f = new financial_1.Financial(-9999, -9999, inputs.VATrate, -9999, true, 3, 0.018);
