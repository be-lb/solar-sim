...
var solarSim = function (inputs, constants) {
    ...
    b.user = u;
    var f = new financial_1.Financial(constants, inputs.VATrate, inputs.annualMaintenanceCost, inputs.loan, inputs.loanPeriod, inputs.loanRate);
    f.building = b;
    f.computePVCost();
    f.computeOtherCost();
    ...
    var loanCosts10 = financial_1.computeLoanCosts(f, 10);
    var netGain10 = 0;
    if (f.loan) {
    ...
    var loanCosts25 = financial_1.computeLoanCosts(f, 25);
    var netGain25 = 0;
    if (f.loan) {
...
var thermicSolarSim = function (inputs, constants) {
    ...
    var f = new financial_1.Financial(constants, inputs.VATrate, -9999, inputs.loan, 3, 0.018);
    var gain10 = thermic_1.computeThermicGain(t, 10);
    var gain25 = thermic_1.computeThermicGain(t, 25);
