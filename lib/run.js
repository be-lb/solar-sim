...
var thermicSolarSim = function (inputs) {
    ...
    for (var _i = 0, _a = inputs.roofs; _i < _a.length; _i++) {
        var r = _a[_i];
        var roof = new roof_1.Roof(r.area, r.productivity, r.tilt, 'NA', b);
        b.roofs.push(roof);
    }
    console.log(b);
    var t = new thermic_1.Thermic(inputs.thermicHouseholdPerson, inputs.thermicLiterByPersonByDay, inputs.thermicHotWaterProducer, inputs.thermicCost, inputs.thermicAnnualMaintenanceCost, inputs.thermicMaintenanceRate, inputs.thermicGrant);
    console.log(t);
    return {
        'gain': -99999,
