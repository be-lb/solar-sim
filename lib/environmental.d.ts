...
import { CostFactorOrigin } from './io';
...
declare const getEnvironmentalCosts: (environmental: Environmental, building: Building, constants: import("io-ts").TypeOfProps<{
...
declare const computeSavedCO2Emissions: (actualProduction: number[], constants: import("io-ts").TypeOfProps<{
    max_power: import("io-ts").NumberType;
    co2_emissions_by_kwh: import("io-ts").NumberType;
    meter_cost: import("io-ts").NumberType;
    onduleur_cost_factor: import("io-ts").NumberType;
