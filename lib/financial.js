...
var Financial = (function () {
    function Financial(the_elec_selling_price, the_CV_price, the_VAT_rate, the_annual_maintenance_cost) {
...
var computeFinancialAmortization = function (building, fin, nYears, currentYear) {
    ...
    for (var i = 1; i <= nYears; i++) {
        ...
        var OMCosts = -1 * computeActualPrice(fin.OMCost, fin.inflationRate, i);
        console.log(OMCosts);
        var totalCost = 0;
        if (i === fin.onduleurReplacementRate) {
            ...
            totalCost = OMCosts + CVAmount[i - 1] + elecBuying + elecSelling - 10000;
        }
